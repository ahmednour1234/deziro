            ...
            <div class="col-lg-2 col-md-6 mb-0 mt-4  mx-3">
                <form action="" method="get" id="searchForm">
                    <div class="d-flex gap-3">
                        ...
                        {{-- <div class="col-lg-2 input-group input-group-merge">
                            <select name="order_type" class="form-select" value="{{ request()->get('order_type') }}">
                                <option value=""> Select type</option>
                                <option value="1" {{ request()->get('order_type') == '1' ? 'selected' : '' }}>Individual
                                </option>
                                <option value="2" {{ request()->get('order_type') == '2' ? 'selected' : '' }}>Store
                                </option>
                            </select>
                        </div> --}}
                        ...
                        {{-- <div class="col-lg-2 input-group input-group-merge">
                            <select name="order_active" class="form-select" value="{{ request()->get('order_active') }}">
                                <option value=""> Select Activate</option>
                                <option value="1" {{ request()->get('order_active') == '1' ? 'selected' : '' }}>Active
                                </option>
                                <option value="0" {{ request()->get('order_active') == '0' ? 'selected' : '' }}>
                                    Inactive</option>
                            </select>
                        </div> --}}

                        {{-- <div class="col-lg-2 input-group input-group-merge">
                            <select name="order_ban" class="form-select" value="{{ request()->get('order_ban') }}">
                                <option value=""> Select banned</option>
                                <option value="1" {{ request()->get('order_ban') == '1' ? 'selected' : '' }}>Banned
                                </option>
                                <option value="0" {{ request()->get('order_ban') == '0' ? 'selected' : '' }}>
                                    Not Banned</option>
                            </select>
                        </div> --}}
                    ...
                    <div class="d-flex gap-3 my-4 " style="margin-left:200%">
                        ...
                        <div class="">
                            {{-- <a href="{{ route('ordersexport', $_GET) }}" class="btn btn-success">Excel</a> --}}
                        </div>
