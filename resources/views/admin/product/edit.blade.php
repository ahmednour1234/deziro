				...
				<form action="{{ route('admin.product.update', $product->id) }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
					...
					<div class="row g-3">
						...
						<div class="col-12">
							...
							<div id="variants-container" class="mt-3">
								...
								<div class="row g-2 align-items-end mb-2 border rounded p-2">
									...
									<div class="col-6 col-md-3">
										...
										<input type="number" step="0.01" name="variants[{{ $vIndex }}][price]" class="form-control" value="{{ $variant->price }}" />
									</div>
									<div class="col-6 col-md-3">
										<label class="form-label">Quantity</label>
										<input type="number" min="0" name="variants[{{ $vIndex }}][quantity]" class="form-control" value="{{ $variant->quantity }}" />
									</div>
...
<script>
	(function(){
		...
		// Attach remove handlers for pre-rendered rows
