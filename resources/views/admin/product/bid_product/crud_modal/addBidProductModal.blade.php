                ...
                <div class="modal-body">
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-12 mb-0">
                            ...
                            <select class="form-control select2 store" id="store"
                        ...
                        <div class="col-12 mb-0 ">
                            <label for="" class="form-label"> Count Down <span class="text-error"></span></label>
                            <div class="d-flex">
                            <div class="col-4 ">
                                <input type="number" id="day" name="day"class="form-control day" placeholder="Day ">
                                <span class="text-danger" id="error_day"></span>
                                </div>
                                <div class="col-4 mx-1">
                                    <input type="number" id="hour" name="hour"class="form-control hour" placeholder="Hour">
                                    <span class="text-danger" id="error_hour"></span>
                                    </div>
                                    <div class="col-4 ">
                                        <input type="number" id="minute" name="minute"class="form-control minute" placeholder="Minute">
                        ...
                        <div class="col-12 mb-0 ">
                            <label for="bid_starting_price" class="form-label"> Bid Starting Price <span class="text-error"></span></label>
                            <input type="number" id="bid_starting_price" name="bid_starting_price"class="form-control bid_starting_price">
