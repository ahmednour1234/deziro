                ...
                <div class="modal-body">
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-12 mb-0">
                            ...
                            <select class="form-control select2 store" id="edit_bid_store"
                        ...
                        <div class="col-6 mb-0">
                            <label for="category" class="form-label"> Select Category <span
                                    class="text-error"></span></label>
                            <select class="form-select category" id="edit_bid_category" aria-label="Default select example"
                            ...
                            <span class="text-danger" id="error_edit_bid_category"></span>
                        </div>

                        <div class="col-6 mb-0">
                            <label for="subCategory" class="form-label"> Select SubCategory <span
                                    class="text-error"></span></label>
                            <select class="form-select subCategory" id="edit_bid_subcategory"
                                aria-label="Default select example" name="subCategory" required>
