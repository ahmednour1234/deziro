                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-12 mb-0">
                            ...
                            <label for="store" class="form-label">Select Store <span
                                    class="text-error"></span></label>
                            <select class="form-select store" id="edit_selling_store"
                        ...
                        <div class="col-6 mb-0">
                            <label for="category" class="form-label">Category Name <span
                                    class="text-error"></span></label>
                            <select class="form-select select2 category" id="edit_selling_category" aria-label="Default select example" name="category" required>
                            ...
                            <span class="text-danger" id="error_edit_selling_category"></span>
                        </div>
