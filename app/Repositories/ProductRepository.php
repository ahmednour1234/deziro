...
class ProductRepository extends Repository
{
    ...
    public function create(array $data)
    {
        ...
        // If an admin (type 2) is creating on behalf of a store, respect provided user_id
        if (isset($data['user_id']) && Auth::user() && Auth::user()->type == 2) {
    ...
    public function createVariant($product, $data = [])
    {
        ...
        // Ensure variant is owned by the same user as parent product
    ...
    public function update(array $data, $id)
    {
        ...
        // If an admin (type 2) is updating on behalf of a store, respect provided user_id
        if (isset($data['user_id']) && Auth::user() && Auth::user()->type == 2) {
            $data['user_id'] = (int) $data['user_id'];
        } else {
            $data['user_id'] = Auth::user()->id;
    ...
    {
        // Ensure variant remains owned by the same user as parent product
        $data['user_id'] = $product->user_id;
